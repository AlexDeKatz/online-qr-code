...
const QrCode: React.FC = (props: any) => {
    ...
    const { title, firstName, lastName, contact, email, company, position, address, website }  = {
        title:'Mr',
        firstName:"Likhith",
        lastName:"Kolayari",
        contact:"9916162080",
        email:"kplikhith@gmail.com",
        company:"Deriv DMCC",
            ...
            <section className={classes.card}>
                ...
                <div className={classes.container}>
                    ...
                    <div className={classes.action}>
                        ...
                        <button onClick={createVCard} disabled={true}>Download .VCF</button>
                    </div>
                </div>
